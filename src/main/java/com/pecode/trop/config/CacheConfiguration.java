package com.pecode.trop.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            cm.createCache(com.pecode.trop.repository.UserRepository.USERS_BY_LOGIN_CACHE, jcacheConfiguration);
            cm.createCache(com.pecode.trop.repository.UserRepository.USERS_BY_EMAIL_CACHE, jcacheConfiguration);
